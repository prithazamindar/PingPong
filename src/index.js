...
function game() {
  ...
  if (collision(ball, player)) {
    ...
    if (mode.value == 0.05) ball.speed += 0.1;
    else if (mode.value == 0.08) ball.speed += 0.25;
    else if (mode.value == 0.1) ball.speed += 0.4;
    else if (mode.value == 0.2) ball.speed += 0.55;
    else if (mode.value == 0.3) ball.speed += 0.7;
    // Particles explosion
    if (player === user) {
